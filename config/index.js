export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx1501eb51a3cabb1b",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "80889577cffea54e05fb681a0b8a5671",
   ...
   */
  USERS: [oxMME6Z4TTHyYN8QkCXndtEUa1DE
    {
      // 想要发送的人的名字
      name: "娇娇0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "zBWnP2ZfbQ3Hjr5rZ0vg6rk0qR3rNNo7MP-z5D56_WA",
      // 所在省份
      province: "黑龙江",
      // 所在城市
      city: "大庆",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2005", "date": "10-21"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "李四", "year": "1996", "date": "09-31"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "11-26"},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2021-11-26"},
        // 结婚纪念日
